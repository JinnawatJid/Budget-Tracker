...
| T2 | Define screen flow (Home, Add, History) | ✅ Done | Founder | Create mobile wireframes in Google Stitch (or Figma if unavailable) |
| T3 | Scaffold project (Next.js + TypeScript + Tailwind) | ⏳ In Progress | AI | Initialize repo structure |
